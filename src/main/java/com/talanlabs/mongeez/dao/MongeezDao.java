...
import com.mongodb.*;
import com.talanlabs.mongeez.MongeezConst;
...
public class MongeezDao {
    ...
    private DBCollection getMongeezCollection() {
        return db.getCollection(MongeezConst.SYS_COLLECTION_NAME);
    }
    ...
    public void logChangeSet(ChangeSet changeSet) {
        ...
        object.append("date", DateFormatUtils.ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT.format(System.currentTimeMillis()));
